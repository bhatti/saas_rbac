...
impl<'a> RepositoryLocator<'a> {
    ...
    pub fn new(data_source: &dyn DataSource) -> RepositoryLocator {
    ...
    /// Creates instance of realm repository for persisting security realms
    pub fn build_realm_repository(data_source: &dyn DataSource) -> super::realm_repository::SecurityRealmRepository {
    ...
    /// Creates instance of organization repository for persisting org data
    pub fn build_org_repository(data_source: &dyn DataSource) -> super::org_repository::OrganizationRepository {
    ...
    /// Creates instance of audit-record repository for persisting logs
    pub fn build_audit_record_repository(data_source: &dyn DataSource) -> super::audit_record_repository::AuditRecordRepository {
        super::audit_record_repository::AuditRecordRepository{data_source: data_source}
    }

    /// Creates instance of group repository for persisting organization groups data
    pub fn build_group_repository(data_source: &dyn DataSource) -> super::group_repository::GroupRepository {
    ...
    /// Creates instance of principal repository for persisting organization users
    pub fn build_principal_repository(data_source: &dyn DataSource) -> super::principal_repository::PrincipalRepository {
    ...
    /// Creates instance of group-principal repository for defining association between groups and
    /// principals
    pub fn build_group_principal_repository(data_source: &dyn DataSource) -> super::group_principal_repository::GroupPrincipalRepository {
    ...
    /// Creates instance of resource repository for persisting target objects that need protection
    pub fn build_resource_repository(data_source: &dyn DataSource) -> super::resource_repository::ResourceRepository {
    ...
    /// Creates resource-insstance repository for persisting instances of resources
    pub fn build_resource_instance_repository(data_source: &dyn DataSource) -> super::resource_instance_repository::ResourceInstanceRepository{
    ...
    /// Creates resource-quota repository for persisting resource-quotas
    pub fn build_resource_quota_repository(data_source: &dyn DataSource) -> super::resource_quota_repository::ResourceQuotaRepository {
    ...
    /// Creates instance of role repository for persisting roles that are available for
    /// the organizations
    pub fn build_role_repository(data_source: &dyn DataSource) -> super::role_repository::RoleRepository {
    ...
    /// Creates instance of role-roleable repository for defining association objects that can be tied with the role object.
    pub fn build_role_roleable_repository(data_source: &dyn DataSource) -> super::role_roleable_repository::RoleRoleableRepository {
    ...
    /// Creates instance of claim repository for persisting mapping of resource and actions
    pub fn build_claim_repository(data_source: &dyn DataSource) -> super::claim_repository::ClaimRepository {
    ...
    /// Creates instance of claim-claimable repository for persisting mapping of claim and
    /// claimable
    pub fn build_claim_claimable_repository(data_source: &dyn DataSource) -> super::claim_claimable_repository::ClaimClaimableRepository {
    ...
    /// Creates instance of license-policy repository for persisting organization overall access
    pub fn build_license_policy_repository(data_source: &dyn DataSource) -> super::license_policy_repository::LicensePolicyRepository {
    ...
    /// Creates instance of rbac repository
    pub fn build_persistence_manager(data_source: &dyn DataSource) -> super::manager::PersistenceManager {
